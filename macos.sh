...
# TODO move settings for iterm to here


# defaults write com.apple.dock pinning -string end # Pin the dock to the corner
# defaults write com.apple.dock tilesize -int 40 # Pin the dock to the corner
# defaults write com.apple.finder QLEnableTextSelection -bool TRUE # Enable text selection in the Quick Look for Finder
...
# Comparing values
# defaults read xyz > before
# defaults read xyz > after
